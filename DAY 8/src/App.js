...
import UserCampaign from './components/pages/usercampaign';
import EmailMarketing from './components/pages/marketing';
  ...
  return (
    <Router>
      <Routes>
        ...
        <Route path="/ucamp" element={<UserCampaign/>} />
        <Route path="/emailsub" element={<EmailSubscribers/>} />
        <Route path="/mark" element={<EmailMarketing/>} />
